...
**Note on baseline comparisons:** This artifact includes only the APEX implementation. Baseline numbers are taken from the respective papers and our independent measurements on the same hardware, as reported in the paper. Reviewers can verify APEX's absolute performance and correctness; relative speedup claims can be validated by comparing against the baseline numbers in the paper.
...
### §7.1 TPC-H Benchmarks
- **Run individually**: `./artifacts/scripts/run_tpch.sh [--quick]`
- **Paper reference**: Figure 4, Table 2
...
### §7.1 Hybrid Queries
- **Run individually**: `./artifacts/scripts/run_hybrid.sh [--quick]`
- **Paper reference**: Figure 5, Tables 3, 4
...
- **Run individually**: `./artifacts/scripts/run_storage.sh [--quick]`
- **Paper reference**: Tables 5, 6
...
### §7.3 Numeric Comparison
- **Run individually**: `./artifacts/scripts/run_comparison.sh [--quick]`
...
- **Run individually**: `./artifacts/scripts/run_pattern.sh [--quick]`
- **Paper reference**: Figures 7, 8
...
### §7.4 Lazy Carry Propagation
- **Run individually**: `./artifacts/scripts/run_lazy_carry.sh [--quick]`
- **Paper reference**: Figure 9, Table 7
...
Quick mode (`run.sh --quick`) uses a small ring dimension (N=2^7) with minimal SIMD parallelism, so trends may appear distorted. This is expected. Run `run.sh` without flags for accurate reproduction.
